# Generated by Django 2.0 on 2018-01-05 07:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='period',
            name='browser',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='browsers', related_query_name='browser', to='shorterner.PeriodDetail'),
        ),
        migrations.AddField(
            model_name='period',
            name='country',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='countries', related_query_name='country', to='shorterner.PeriodDetail'),
        ),
        migrations.AddField(
            model_name='period',
            name='platform',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='platforms', related_query_name='platform', to='shorterner.PeriodDetail'),
        ),
        migrations.AddField(
            model_name='period',
            name='referrer',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='referrers', related_query_name='referrer', to='shorterner.PeriodDetail'),
        ),
        migrations.AddField(
            model_name='error',
            name='error',
